...
public class UsuarioController {
    ...
    @PutMapping("/{id}")
    @PreAuthorize("hasAuthority('ROL_ADMINISTRADOR') or #id == principal.id")
    ...
    public ResponseEntity<ApiResponse<UsuarioResponse>> cambiarRol(
        ...
        UsuarioResponse response = usuarioService.cambiarRol(id, request, principal.getId());
        return ResponseEntity.ok(ApiResponse.exito("Rol actualizado exitosamente", response));
    }
}